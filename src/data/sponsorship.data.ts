...
export const activationExamples = [
   {
      ...
      imageSrc: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&q=80',
   },
   {
      brand: 'Samsung',
      description:
         'Product activation in Grand Atrium with interactive demo stations reaching 80K+ visitors over 3 days.',
      imageSrc: 'https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=600&q=80',
   },
   {
      brand: 'Mercedes-Benz',
      description:
         'Luxury vehicle display throughout property atrium with VIP test-drive integration in adjacent lots.',
      imageSrc: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=600&q=80',
   },
] as const
