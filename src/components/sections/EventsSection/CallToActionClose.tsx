      ...
      <div id="contact" aria-label="Contact and get started">
         <div className="ctaClose">
            <div className="ctaCloseInner">
               ...
               >
                  ...
                  <p className="ctaCloseSubtitle">
                     Connect with our commercial team to explore leasing, sponsorship, and event opportunities at
                     American Dream.
                  </p>
            ...
            <div className="footerBar">
               ...
               <p className="footerCopyright">© {new Date().getFullYear()} American Dream. All rights reserved.</p>
