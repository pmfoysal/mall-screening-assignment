            ...
            <div className="eventsContent">
               ...
               >
                  {eventTypes.map((eventType) => (
                     <motion.div key={eventType.id} className="eventTypeCard" role="listitem" variants={staggerItem}>
                        <div className="eventTypeIcon">{eventIcons[eventType.icon ?? 'star']}</div>
                        <div>
                        ...
                        {eventType.capacity && <span className="eventCapacityBadge">{eventType.capacity}</span>}
                     </motion.div>
                  ))}
               </motion.div>
