...
export function DiningSection() {
   ...
   const filteredVenues =
      activeCategory === 'all' ? diningVenues : diningVenues.filter((v) => v.category === activeCategory)
            ...
            <div className="diningInner">
               ...
               >
                  {filteredVenues.map((venue) => (
                     <motion.div key={venue.id} className="diningCard" role="listitem" variants={staggerItem}>
                        {venue.isSignature && (
               ...
               >
                  <p className="dwellMessageQuote">
                     &ldquo;Dining at American Dream isn&apos;t just a meal — it&apos;s the reason people stay for 6
                     hours, not 2.&rdquo;
                  </p>
                  <p className="dwellMessageSub">Average dwell time: 4.2 hours · Dining conversion: 78% of visitors</p>
