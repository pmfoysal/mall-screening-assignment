        ...
        <div className="diningInner">
          ...
          >
            {diningCategories.map((cat) => (
              <button
                ...
                className={cn(
                  "categoryPill",
                  activeCategory === cat.id && "categoryPillActive",
                )}
          ...
          >
            {filteredVenues.map((venue) => (
              ...
              >
                {venue.isSignature && (
                  <span
                    className="signatureBadge"
                    aria-label="Signature dining destination"
                  >
                    Signature
                  </span>
                )}
          ...
          >
            <p className="dwellMessageQuote">
              "Dining at American Dream isn't just a meal — it's the reason
              people stay for 6 hours, not 2."
            </p>
